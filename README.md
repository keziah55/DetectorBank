...
`apt install python3-dev swig build-essential autoconf-archive libtool libcereal-dev librapidxml-dev libfftw3-dev doxygen python3 graphviz texlive-latex-base python3-tap`
